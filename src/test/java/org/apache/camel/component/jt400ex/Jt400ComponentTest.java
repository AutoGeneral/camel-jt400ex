...
public class Jt400ComponentTest extends Jt400TestSupport {
    ...
    public void testCreateDatqEndpoint() throws Exception {
        Endpoint endpoint = component
                .createEndpoint("jt400ex://user:password@host/qsys.lib/library.lib/queue.dtaq?connectionPool=#mockPool");
    ...
    public void testCreatePgmEndpoint() throws Exception {
        Endpoint endpoint = component
                .createEndpoint("jt400ex://user:password@host/qsys.lib/library.lib/queue.pgm?connectionPool=#mockPool");
        assertNotNull(endpoint);
        assertTrue(endpoint instanceof Jt400Endpoint);
    }
    ...
    public void testCreateEndpointForOtherObjectType() throws Exception {
        try {
            component.createEndpoint("jt400ex://user:password@host/qsys.lib/library.lib/program.xxx");
    ...
    public void testCreateDatqSecuredEndpoint() throws Exception {
        Endpoint endpoint = component
                .createEndpoint("jt400ex://user:password@host/qsys.lib/library.lib/queue.dtaq?connectionPool=#mockPool&secured=true");
        assertNotNull(endpoint);
        assertTrue(endpoint instanceof Jt400Endpoint);
    ...
    public void testCreatePgmSecuredEndpoint() throws Exception {
        Endpoint endpoint = component
                .createEndpoint("jt400ex://user:password@host/qsys.lib/library.lib/queue.pgm?connectionPool=#mockPool&secured=true");
        assertNotNull(endpoint);
        assertTrue(endpoint instanceof Jt400Endpoint);
        assertTrue(((Jt400Endpoint) endpoint).isSecured());
    }
