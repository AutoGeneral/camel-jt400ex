...
public class Jt400PgmEndpointTest extends Jt400TestSupport {
    ...
    public void setUp() throws Exception {
        super.setUp();
        endpoint = (Jt400PgmEndpoint) resolveMandatoryEndpoint("jt400ex://" + USER + ":" + PASSWORD
                + "@" + HOST + PGM
    ...
    public void testToString() {
        assertEquals("Endpoint[jt400ex://USER:xxxxxx@host/qsys.lib/library.lib/prog.pgm?connectionPool=%23mockPool&fieldsLength=10%2C512%2C255&format=binary&guiAvailable=true&outputFieldsIdx=1%2C2]",
                     endpoint.toString());
    }
}
