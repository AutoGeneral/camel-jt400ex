...
public class Jt400DataQueueEndpointTest extends Jt400TestSupport {
    ...
    public void setUp() throws Exception {
        super.setUp();
        endpoint = (Jt400DataQueueEndpoint) resolveMandatoryEndpoint("jt400ex://user:password@host/qsys.lib/library.lib/queue.dtaq?ccsid=500&format=binary&guiAvailable=true&connectionPool=#mockPool");
    }
    ...
    public void testToString() {
        assertEquals("Endpoint[jt400ex://user:xxxxxx@host/qsys.lib/library.lib/queue.dtaq?ccsid=500&connectionPool=%23mockPool&format=binary&guiAvailable=true]", endpoint.toString());
    }
}
