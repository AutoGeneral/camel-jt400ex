...
public class Jt400DataQueueEndpoint extends DefaultPollingEndpoint {
    ...
    /**
     *
     * @param keyed true if the data queue being read is keyed, and false otherwise
     */
    ...
    /**
     *
     * @return true if the data queue being read is keyed, and false otherwise
     */
    ...
    /**
     *
     * @param searchKeysProvider The name of the Spring bean that holds the list of search keys to use
     */
    public void setSearchKeysProvider(String searchKeysProvider) {
        this.searchKeysProvider = searchKeysProvider;
    }

    /**
     *
     * @return The name of the Spring bean that holds the list of search keys to use
     */
